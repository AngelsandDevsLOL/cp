...
public class AGameOfRisk {
    ...
    public static void main (String[] args) throws IOException {
        for (int i = 6; i <= 6; i++) {
            PrintWriter in = new PrintWriter(new FileWriter(i + ".in"));
            PrintWriter out = new PrintWriter(new FileWriter(i + ".out"));
            ...
            for (int j = 0; j < n; j++) {
                for (int k = 0; k < n; k++) {
                    input[j][k] = (int) (Math.random() * 10) + 990;
                    in.print(input[j][k] + " ");
                }
                in.println();
            }
            int ans = method(n, input);
            out.println(ans);
            out.close();
            in.close();
        }
    ...
    public static int method(int n, int[][] input) throws IOException {
